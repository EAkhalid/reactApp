const validateEmail = ({ email, setEmailError }) => {
  ...
  const validateSurName = ({ surName, setSurNameError }) => {
    return surName && surName.length < 5
      ? setSurNameError('Full name is too short')
  ...
  export { validateEmail,validateSurName, validateFullName, validateMessage, validatePhone };